...
| **3 判断层** | 「什么时候用哪个」「代价是什么」 | 中高级的分水岭。答不出这一层，前面两层白答 | [消息队列](/middleware/#interview)、[Redis](/database/redis/#interview)、[Spring Cloud](/java/spring/spring-cloud/#interview-index) |
