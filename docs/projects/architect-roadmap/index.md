...
| **L1 开发** | ✅ **路线起点** | 读懂别人写的代码，按现有风格独立交付一个模块 |
| **L2 高级开发** | ✅ | 交付不需要人盯，能负责一块，并对线上问题给出根因 |
| **L3 架构师** | ✅ | 能设计系统，并说清「为什么这么选、放弃了什么」 |
| **L4 CIO** | ⚠️ 素材偏薄 | 对一条业务线的技术结果负责——规划、算账、带团队 |
...
**起点在哪读**：[L1 开发 · 能独立交付一个模块](/projects/architect-roadmap/developer/)——七步阅读顺序、每页「读到哪一层就停」、离场自检六个问题。
...
| 按深度走路线 | 本页 → [L1 开发清单](/projects/architect-roadmap/developer/)（起点） |
